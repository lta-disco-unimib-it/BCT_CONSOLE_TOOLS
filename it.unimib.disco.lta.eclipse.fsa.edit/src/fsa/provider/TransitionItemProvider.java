 ...
 * </copyright>
 *
 * $Id: TransitionItemProvider.java,v 1.1 2008-06-20 19:40:33 terragni Exp $
 */
package fsa.provider;
...
/**
 * This is the item provider adapter for a {@link fsa.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FsaPackage.Literals.TRANSITION__DESCRIPTION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FsaPackage.Literals.TRANSITION__TO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FsaPackage.Literals.TRANSITION__FROM,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Transition.class)) {
			case FsaPackage.TRANSITION__DESCRIPTION:
