...
void testHandlerNoItemsAvailable(){
	...
	string item4("DellInspiron-17");
	string item5("DellInspiron-15");
	...
	assertEquals ( 1, resultsToShow->size());
}
...
void testHandlerTwoItemsAvailable(){
	...
	assertEquals ( 3, resultsToShow->size());
	...
	it++;
	assertEquals ( make_pair(item2,14), *it);

	it++;
	assertEquals ( make_pair("Total",21), *it);
}
...
//	if ( testToRun == NULL || (*testToRun).compare("testHandlerNoItemsAvailable") == 0  ){
//		runTest ( "testHandlerNoItemsAvailable", testHandlerNoItemsAvailable );
//	}
...
//	}
//	if ( testToRun == NULL || (*testToRun).compare("testHandlerTwoItemsAvailable") == 0  ){
//		runTest ( "testHandlerTwoItemsAvailable", testHandlerTwoItemsAvailable );
//	}
