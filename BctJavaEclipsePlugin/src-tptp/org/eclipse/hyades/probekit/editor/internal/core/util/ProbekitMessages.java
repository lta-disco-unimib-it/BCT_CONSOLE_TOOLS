 ...
 * $Id: ProbekitMessages.java,v 1.1 2011-12-01 21:34:09 pastore Exp $ 
 * 
 * Contributors: 
...
public class ProbekitMessages {
	private static final String BUNDLE_NAME = "org.eclipse.hyades.probekit.editor.internal.core.util.messages"; //$NON-NLS-1$
	
	private ProbekitMessages(){		
	}
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, ProbekitMessages.class);
	}
}
