...
public class ViolationsExportWizard extends Wizard implements IExportWizard {

	private IFile mcFile;
	private IoExportWizardPage ioExportPage;
	private MonitoringConfiguration mc;

	public ViolationsExportWizard() {
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		ioExportPage = new IoExportWizardPage("Export Anomalies");
