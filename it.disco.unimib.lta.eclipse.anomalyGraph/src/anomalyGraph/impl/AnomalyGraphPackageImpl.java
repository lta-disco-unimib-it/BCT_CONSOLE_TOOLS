 ...
 * </copyright>
 *
 * $Id: AnomalyGraphPackageImpl.java,v 1.1 2008-07-07 20:07:50 pastore Exp $
 */
package anomalyGraph.impl;

import anomalyGraph.AnomalyGraphFactory;
import anomalyGraph.AnomalyGraphPackage;
import anomalyGraph.BctFSAModelViolation;
import anomalyGraph.BctIOModelViolation;
import anomalyGraph.BctModelViolation;
import anomalyGraph.Graph;
...
public class AnomalyGraphPackageImpl extends EPackageImpl implements AnomalyGraphPackage {
	 ...
	 * @see anomalyGraph.AnomalyGraphPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getBctFSAModelViolation_CurrentState() {
	...
	public void createPackageContents() {
		...
		createEAttribute(bctFSAModelViolationEClass, BCT_FSA_MODEL_VIOLATION__CURRENT_STATE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getBctFSAModelViolation_CurrentState(), ecorePackage.getEString(), "currentState", null, 0, 1, BctFSAModelViolation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(violationTypesEEnum, ViolationTypes.INVARIANT_VIOLATDED);
