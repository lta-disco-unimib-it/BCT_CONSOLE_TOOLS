 ...
 * <ul>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getId <em>Id</em>}</li>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getViolatedModel <em>Violated Model</em>}</li>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getViolation <em>Violation</em>}</li>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getCreationTime <em>Creation Time</em>}</li>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getActiveActions <em>Active Actions</em>}</li>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getActiveTests <em>Active Tests</em>}</li>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getPid <em>Pid</em>}</li>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getThreadId <em>Thread Id</em>}</li>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getStackTrace <em>Stack Trace</em>}</li>
 *   <li>{@link it.unimib.disco.lta.eclipse.anomalyGraph.impl.BctModelViolationImpl#getViolationType <em>Violation Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
