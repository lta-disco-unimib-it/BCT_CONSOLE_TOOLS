...
public class MessageFormatParser extends
		it.unimib.disco.lta.eclipse.anomalyGraph.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS
							.bind(
									it.unimib.disco.lta.eclipse.anomalyGraph.diagram.part.Messages.MessageFormatParser_InvalidInputError,
