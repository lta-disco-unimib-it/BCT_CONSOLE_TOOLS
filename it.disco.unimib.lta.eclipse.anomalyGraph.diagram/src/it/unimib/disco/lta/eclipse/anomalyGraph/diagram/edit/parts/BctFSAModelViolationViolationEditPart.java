 ...
 * @generated
 */
public class BctFSAModelViolationViolationEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public BctFSAModelViolationViolationEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof it.unimib.disco.lta.eclipse.anomalyGraph.diagram.edit.policies.AnomalyGraphTextSelectionEditPolicy) {
			((it.unimib.disco.lta.eclipse.anomalyGraph.diagram.edit.policies.AnomalyGraphTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					...
					it.unimib.disco.lta.eclipse.anomalyGraph.diagram.edit.parts.AnomalyGraphEditPartFactory
