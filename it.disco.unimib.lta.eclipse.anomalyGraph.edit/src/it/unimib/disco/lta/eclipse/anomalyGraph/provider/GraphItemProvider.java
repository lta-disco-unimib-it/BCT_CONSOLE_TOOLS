 ...
 * </copyright>
 *
 * $Id: GraphItemProvider.java,v 1.1 2008-07-07 20:08:50 pastore Exp $
 */
...
/**
 * This is the item provider adapter for a {@link it.unimib.disco.lta.eclipse.anomalyGraph.Graph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AnomalyGraphPackage.Literals.GRAPH__VIOLATIONS);
			childrenFeatures.add(AnomalyGraphPackage.Literals.GRAPH__RELATIONSHIPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AnomalyGraphPackage.Literals.GRAPH__VIOLATIONS,
				 AnomalyGraphFactory.eINSTANCE.createBctIOModelViolation()));

		newChildDescriptors.add
			(createChildParameter
				(AnomalyGraphPackage.Literals.GRAPH__VIOLATIONS,
				 AnomalyGraphFactory.eINSTANCE.createBctFSAModelViolation()));

		newChildDescriptors.add
			(createChildParameter
				(AnomalyGraphPackage.Literals.GRAPH__RELATIONSHIPS,
				 AnomalyGraphFactory.eINSTANCE.createRelationship()));
	}
