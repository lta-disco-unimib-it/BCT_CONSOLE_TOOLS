...
import fsa.State;
import fsa.diagram.edit.helpers.FsaBaseEditHelper;
import fsa.diagram.part.FsaVisualIDRegistry;

/**
 * @generated
 */
public class FsaBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(FsaVisualIDRegistry
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest.setParameter(
					FsaBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		if (elementType != null) {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateTransition_3001(fsa.FSA container,
		 ...
		 * @generated
		 */
		public static boolean canExistTransition_3001(fsa.FSA container,
				State source, State target) {
			return true;
		}
