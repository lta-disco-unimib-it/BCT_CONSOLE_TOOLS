...
import fsa.diagram.edit.policies.FsaTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TransitionDescriptionEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				FsaVisualIDRegistry
						.getType(fsa.diagram.edit.parts.TransitionDescriptionEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public TransitionDescriptionEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof FsaTextSelectionEditPolicy) {
			((FsaTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new FsaParserProvider.HintAdapter(
					FsaElementTypes.Transition_3001, getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), FsaEditPartFactory
