...
import fsa.diagram.part.FsaDiagramEditor;
 ...
 * @generated
 */
public class FsaNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof FsaNavigatorItem) {
					selectedElement = ((FsaNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, FsaDiagramEditor.ID);
