...
public class TestCBMCIntegration_VSSE {
	...
	private static final String EXPECTED_return_GT_0 = "src/store.c\tavailable_items\tassert( return >= 0 );";
	...
	private static String originalProgram = TestsRunner.testPath (  "/home/BCT/workspace_BCT_Testing/VSSE_short_v1/program" );
	private static String modifiedProgram = TestsRunner.testPath (  "/home/BCT/workspace_BCT_Testing/VSSE_short_v2/program" );
	private static String modifiedSrc = TestsRunner.testPath ( "/home/BCT/workspace_BCT_Testing/VSSE_short_v2" );
...
//		lines = lines.subList(lines.size()-11, lines.size());
	...
	public void testConsoleExecution_UnitChecking() throws IOException{
		...
		assertEquals( "\t"+EXPECTED_return_0_1, lines.get(3) );
	}
	...
	public void testConsoleExecution_UnitChecking_singleClaim() throws IOException{
		...
		assertEquals( "\t"+EXPECTED_TOTAL_GT_0_38, lines.get(1) );
		assertEquals( "\t"+EXPECTED_TOTAL_GT_0_41, lines.get(2) );
		assertEquals( "\t"+EXPECTED_return_GT_0, lines.get(3) );
		assertEquals( "\t"+EXPECTED_return_0_1, lines.get(4) );
	}
